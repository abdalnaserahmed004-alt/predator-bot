const handler = async (m, { conn, bot, args }) => {
    ...
    // حركة المطور أحمد (يا عم المجال) لو استخدم الأمر بره جروب
    ...
    try {
        ...
        let messageText = `*亗 PREDATOR GROUP RADAR 亗*\n`;
        messageText += `*────────────────────*\n`;
        ...
        messageText += `> _Dev: Ahmed Abdel Nasser_`;
